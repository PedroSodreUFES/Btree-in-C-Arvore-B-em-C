...
ArvoreB *retiraArvore(ArvoreB *arvore, int chave); // PDF do professor não imprime nada na remoção, então é possível que possa ser void
...
ArvoreB *garanteMinimo(ArvoreB *sentinela, No *no, int idx);
